...
class LR():
    ...
    def train(self, data, params):
        """ train model """
        lrm = LogisticRegression(regParam=params, weightCol='class_weight', standardization=False)
    ...
    def param_grid(self, data):
        ...
        model = LogisticRegression(weightCol='class_weight', standardization=False)
