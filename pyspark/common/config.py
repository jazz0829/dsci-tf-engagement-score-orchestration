...
C_ACCOUNTING_ESTABLISHED = {
    ...
    "training_data_path" : "s3://dd-dsci-contract-prediction-428785023349-eu-west-1/churn/train/accounting_established",
    "model_path" : "s3://dd-dsci-contract-prediction-428785023349-eu-west-1/churn/model/accounting_established",
    "statistics_path" : "s3://dd-dsci-contract-prediction-428785023349-eu-west-1/churn/statistics/accounting_established",
    "predictions_path" : "s3://dd-dsci-contract-prediction-428785023349-eu-west-1/churn/prediction/accounting_established"}
...
C_ACCOUNTING_ONBOARDING = {
    ...
    "label": "churned",
    "training_data_path" : "s3://dd-dsci-contract-prediction-428785023349-eu-west-1/churn/train/accounting_onboarding",
    "model_path" : "s3://dd-dsci-contract-prediction-428785023349-eu-west-1/churn/model/accounting_onboarding",
    "statistics_path" : "s3://dd-dsci-contract-prediction-428785023349-eu-west-1/churn/statistics/accounting_onboarding",
    "predictions_path" : "s3://dd-dsci-contract-prediction-428785023349-eu-west-1/churn/prediction/accounting_onboarding"}
...
C_ACCOUNTANCY = {
    ...
    "label": "churned",
    "training_data_path" : "s3://dd-dsci-contract-prediction-428785023349-eu-west-1/churn/train/accountancy",
    "model_path" : "s3://dd-dsci-contract-prediction-428785023349-eu-west-1/churn/model/accountancy",
    "statistics_path" : "s3://dd-dsci-contract-prediction-428785023349-eu-west-1/churn/statistics/accountancy",
    "predictions_path" : "s3://dd-dsci-contract-prediction-428785023349-eu-west-1/churn/prediction/accountancy"}
...
C_MANUFACTURING = {
    ...
    "label": "churned",
    "training_data_path" : "s3://dd-dsci-contract-prediction-428785023349-eu-west-1/churn/train/manufacturing",
    "model_path" : "s3://dd-dsci-contract-prediction-428785023349-eu-west-1/churn/model/manufacturing",
    "statistics_path" : "s3://dd-dsci-contract-prediction-428785023349-eu-west-1/churn/statistics/manufacturing",
    "predictions_path" : "s3://dd-dsci-contract-prediction-428785023349-eu-west-1/churn/prediction/manufacturing"}
...
C_PROFESSIONAL_SERVICES = {
    ...
    "predictors":  ["recent_use_mobile", "login_freq", "has_sales_invoice", "log_sales_entry_count",
                    ...
                    "environment"],
    "label": "churned",
    "training_data_path" : "s3://dd-dsci-contract-prediction-428785023349-eu-west-1/churn/train/professional_services",
    "model_path" : "s3://dd-dsci-contract-prediction-428785023349-eu-west-1/churn/model/professional_services",
    "statistics_path" : "s3://dd-dsci-contract-prediction-428785023349-eu-west-1/churn/statistics/professional_services",
    "predictions_path" : "s3://dd-dsci-contract-prediction-428785023349-eu-west-1/churn/prediction/professional_services"}
...
C_WHOLESALE_DISTRIBUTION = {
    ...
    "predictors":  ["tenure_in_months_upgrade", "recent_use_mobile", "login_freq", "accountant_or_linked",
                    ...
                    "environment"],
    "label": "churned",
    "training_data_path" : "s3://dd-dsci-contract-prediction-428785023349-eu-west-1/churn/train/wholesale_distribution",
    "model_path" : "s3://dd-dsci-contract-prediction-428785023349-eu-west-1/churn/model/wholesale_distribution",
    "statistics_path" : "s3://dd-dsci-contract-prediction-428785023349-eu-west-1/churn/statistics/wholesale_distribution",
    "predictions_path" : "s3://dd-dsci-contract-prediction-428785023349-eu-west-1/churn/prediction/wholesale_distribution"}
...
def get_config(category, config_name):
    ''' Get configuration dictionary'''
    return CONFIG[category][config_name]
